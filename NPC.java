...
public class NPC {
    ...
    public void talk(){
        ...
        if(!hasAskedName){
            ...
            System.out.println("Cute Servant: Ok "+ playerName + ". Listen to me. You are in the Kingdom of Velmoria. One of the most dangerous kingdoms ever in the universe.\n I am telling you right now, YOU will be stuck in here forever. You must run and escape. \nThere is evil queen who runs this kingdom. If she finds you, she will trap you here forever. Wanna know how to get out of here: (yes/no)");
            ...
            //player refuses, but she will sya anyway
                ...
                System.out.println("Cute Servant: What are you? Stupid? dumb? Your gonna be stuck here forever. You need to get out. Whatever. I will tell you anyway, listen up.");
            ...
            System.out.println("Remember. Find the items, avoid the queen, find the witch. GO GO. LET'S SEE IF YOU CAN MAKE IT OUT OF HERE!");
            System.out.println();
        } else {
